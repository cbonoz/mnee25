...
export default function About() {
    ...
    const features = [
        {
            icon: <SafetyOutlined style={{ fontSize: '24px', color: '#6b9eff' }} />,
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 24px' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
                ...
                <Paragraph style={{ fontSize: '20px', color: '#666', maxWidth: '700px', margin: '0 auto 32px' }}>
                    <b>OpenQuote</b> is a decentralized form + payment system for any service or service provider. Collect structured client info, generate offers, and manage payments—all on-chain, with wallet-based authentication and smart contract automation.
                </Paragraph>
                        ...
                        {useCases.map((useCase, index) => (
                            <Col key={index} xs={24} sm={12}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                    <CheckCircleTwoTone twoToneColor="#6b9eff" style={{ fontSize: '16px' }} />
                                    <Text>{useCase}</Text>
                                </div>
                            </Col>
                        ))}
